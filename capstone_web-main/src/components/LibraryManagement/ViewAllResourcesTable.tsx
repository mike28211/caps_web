...
const dummyData = [
    { title: 'Understanding Anxiety: A Comprehensive Guide', category: 'Anxiety and Stress', publishDate: 'Jan 13, 2023', publishedBy: 'Miguel Trinidad' },
    { title: 'The Art of Happiness: Navigating Mood Disorders', category: 'Depression and Mood Disorders', publishDate: 'Feb 22, 2023', publishedBy: 'Mikko Minoza' },
    { title: 'Cognitive Behavioral Therapy 101', category: 'Therapeutic Approaches', publishDate: 'Mar 7, 2023', publishedBy: 'Miguel Trinidad' },
    { title: 'Daily Self-Care Rituals for Well-Being', category: 'Self-Care and Wellness', publishDate: 'Apr 15, 2023', publishedBy: 'Mikko Minoza' },
    { title: 'Mindful Living: Embracing Meditation Practices', category: 'Mindfulness and Meditation', publishDate: 'May 5, 2023', publishedBy: 'Ian Wendel Flores' },
    { title: 'Building Healthy Relationships: Effective Communication', category: 'Relationships and Communication', publishDate: 'Jun 20, 2023', publishedBy: 'Miguel Trinidad' },
    { title: 'Healing from Trauma: A Path to Recovery', category: 'Trauma and PTSD', publishDate: 'Jul 10, 2023', publishedBy: 'Fritz Sasing' },
    { title: 'Crisis Intervention Strategies and Resources', category: 'Crisis Intervention and Hotlines', publishDate: 'Aug 3, 2023', publishedBy: 'Ian Wendel Flores' },
    { title: 'Advocating for Mental Health Awareness', category: 'Mental Health Advocacy', publishDate: 'Sep 12, 2023', publishedBy: 'Fritz Sasing' },
    { title: 'Cultural Perspectives on Mental Wellness', category: 'Cultural and Diversity Perspectives', publishDate: 'Oct 8, 2023', publishedBy: 'Mikko Minoza' },
];
                    ...
                    <tbody>
                        {dummyData.map((item, index) => (
                            <tr>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p className="text-black dark:text-white">{item.publishedBy}</p>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
