...
import migoyPic from '../images/migoy/migoy-user.jpg';
                  ...
                  <div className="mb-5.5 mt-5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="emailAddress"
                        id="emailAddress"
                        placeholder="migueltrinidad@gmail.com"
                        defaultValue="migueltrinidad@gmail.com"
                      />
                    </div>
                  </div>
                ...
                <form action="#">
                  <div className="mb-4 flex items-center gap-3">
                    <div className="h-14 w-14 rounded-full">
                      <img src={migoyPic} alt="User" className="h-14 w-14 rounded-full"/>
                    </div>
                    <div>
